...
# def extract_feat_res(img, backbone_layers, feat_ids, bottleneck_ids, lids, mask):
#     r""" Extract intermediate features from ResNet"""
#     feats = []
#     feats
#     # Layer 0
#     feat = backbone_layers[0](img) #.conv1.forward(img)   这是layer1
...
#             layers.append(feat.clone())
#         if lid == 3:
#             # print("feat.shape:{}, mask.shape:{}".format(feat.shape, mask.shape))
#             feat = feat * mask
